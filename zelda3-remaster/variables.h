...
#include "types.h"
#include "variables_sprite.h"


enum kNmiSubroutines_Names {
  UploadTilemap_doNothing = 0,
  UploadTilemap = 1,
  UploadBG3Text = 2,
  UpdateOWScroll = 3,
  UpdateSubscreenOverlay = 4,
  UpdateBG1Wall = 5,
  TileMapNothing = 6,
  UpdateLoadLightWorldMap = 7,
  UpdateBG2Left = 8,
  UpdateBGChar3and4 = 9,
  UpdateBGChar5and6 = 10,
  UpdateBGCharHalf = 11,
  UploadSubscreenOverlayLatter = 12,
  UploadSubscreenOverlayFormer = 12,
  UpdateBGChar0 = 14,
  UpdateBGChar1 = 15,
  UpdateBGChar2 = 16,
  UpdateBGChar3 = 17,
  ...
  UpdateObjChar2 = 19,
  UpdateObjChar3 = 20,
  UploadDarkWorldMap = 21,
  UploadGameOverText = 22,
  UpdatePegTiles = 23,
  UpdateStarTiles = 24,
};
...
//extern uint16 hud_tile_indices_buffer[1024];
...
extern int16 link_rupees_goal;// (*(u*)(g_ram+0xF360))
...
//extern uint8 ancilla_type[512];
#define ancilla_step ((uint8*)(g_ram+0xC54))

/// makes item go to link
